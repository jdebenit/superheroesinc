                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead style={{ backgroundColor: '#334155', color: 'white' }}>
                        <tr>
                            ...
                            <th style={{ padding: '1rem', textAlign: 'center' }}>FUErza</th>
                            <th style={{ padding: '1rem', textAlign: 'center' }}>Fiabilidad</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            {selected && (
                <div style={{
                    ...
                    <span style={{ fontWeight: 'bold', color: '#059669' }}>
                        ✓ Fuerza {selected.fuerza}{selected.fiabilidad ? ` (Fiabilidad ${selected.fiabilidad})` : ''}
                    </span>
