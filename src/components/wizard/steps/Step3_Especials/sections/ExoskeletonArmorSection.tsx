    ...
    return (
        <div className="bg-slate-50 border-4 border-slate-700 rounded-xl overflow-hidden shadow-[8px_8px_0px_rgba(0,0,0,0.8)] mb-8">
            <div className="p-6 border-b-4 border-slate-700 bg-white">
                <h3 className="text-2xl font-black text-slate-800 uppercase italic font-comic">Exoesqueleto / Tecnoarmadura</h3>
                <p className="text-gray-600 mt-2">
                    Selecciona el nivel de blindaje y protección de tu armadura o vehículo.
                </p>
            </div>
            ...
            <div className="p-6 bg-slate-100">
                ...
                <div style={{
                    ...
                    <ul style={{ fontSize: '0.875rem', color: '#6b7280', lineHeight: '1.8', paddingLeft: '1.5rem' }}>
                        ...
                        <li><strong>PV:</strong> Puntos de vida adicionales que aporta la armadura/vehículo</li>
                        <li><strong>D.A. Físico:</strong> Daño absorbido (protección)</li>
                    </ul>
                </div>
                ...
                {selectedConfig && (
                    <div style={{
                        ...
                        {(() => {
                            const config = EXOSKELETON_ARMOR_CONFIGS.find(c => c.id === selectedConfig);
                            if (!config) return null;

                            return (
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontWeight: 'bold', color: '#059669', fontFamily: 'var(--font-comic, sans-serif)' }}>
                                        Configuración seleccionada: PV {config.pv} | D.A. {config.daFisico}
                                    </span>
