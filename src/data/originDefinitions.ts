...
export const ORIGIN_CATEGORIES: { [key: string]: OriginCategory } = {
    ...
    "Arcano": {
        name: "Arcano",
        paradaMentalBonus: 20,
        disabledSubtypes: ["Centauro", "Gigante", "Hidra", "Medusa", "Esfinge"],
        defaultEffects: [
        ...
        subtypes: {
            ...
            "Hada Aire": ["+50 al modificador de impacto"],
            "Hada Tierra": ["+50 al modificador de impacto"],
            "Hada Fuego": ["+50 al modificador de impacto"],
