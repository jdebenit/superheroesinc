---
name: "Emiago"
description: "Agente de Recursos Humanos de la Corte Itinerante. Funciones principales: recopilación de información, vigilancia y análisis de datos."
...
Su lealtad es tan resbaladiza como su cuerpo. No responde a jerarquías ni se vincula a ninguna figura de poder dentro de la Corte. Solo reconoce una excepción. [Alice](/personajes/alice). A ella le transmite directamente todo lo que descubre, sin intermediarios ni filtros. Nadie sabe por qué confía en ella ni qué acuerdo existe entre ambos, pero nadie lo cuestiona abiertamente.
